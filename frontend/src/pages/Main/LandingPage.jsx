          ...
          {!isAuthenticated ? (
            ...
            <div className="flex items-center space-x-2">
              <div className="text-gray-700 text-right">
                <span className="text-sm text-gray-500">สวัสดี, <strong>{user?.username}</strong></span>
                <br />
                <Link to="/" className="text-sm text-sky-600 hover:underline">ไปที่หน้าหลัก →</Link>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 pt-20 pb-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            {!isAuthenticated ? (
              ...
              <div className="mt-8">
                <Link to="/" className="px-6 py-3 rounded-xl bg-sky-600 text-white hover:bg-sky-700">เข้าสู่ระบบ</Link>
              </div>
            )}
