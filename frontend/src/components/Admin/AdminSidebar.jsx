...
import { LayoutDashboard, Users as UsersIcon, CalendarClock, FolderGit, FileTerminal } from 'lucide-react';
import Attachment from '../../../../backend/models/Attachment';
...
export default function AdminSidebar({ isSidebarOpen, toggleSidebar }) {
  const navItems = [
    ...
    { name: 'สรุปการประชุม', path: '/admin/meetsummary', icon: <FileTerminal className="w-5 h-5" />, color: 'from-indigo-500 to-purple-500' },
  ];
