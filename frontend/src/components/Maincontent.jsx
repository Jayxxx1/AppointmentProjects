...
export default function MainContent() {
  ...
  // Show overlay when logged in but missing fullName
  ...
  return (
    <div className="min-h-screen bg-[url('/bg/bg.webp')]  bg-cover bg-fixed  bg-no-repeat ">
      <div className="relative z-10 backdrop-blur-sm">
        ...
        {/* Global overlay: require users to add full name before using the app */}
        {/* {needsFullName && (
          ...
          <section className="max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <h1 className="text-3xl sm:text-3xl lg:text-3xl font-semibold leading-tight">
                  ยินดีต้อนรับ {displayName} 👋<br />
