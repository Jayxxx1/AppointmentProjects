              ...
              <div className="hidden md:flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-2xl px-4 py-2 border-2 border-gray-200/50 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-center space-x-2">
                  <div className="relative group">
                    ...
                    {isProfileMenuOpen && (
                      <div className="absolute top-12  w-48 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200/50 z-50">
                        <Link
                          to="/profile"
                        ...
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors duration-200"
                        >
                          ออกจากระบบ
                        </button>
                      </div>
